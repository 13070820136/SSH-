    ...
    <script type="text/javascript">
            ...
            "menus": [
                {
                    ...
                    "menuid": "3", "icon": "icon-sys", "menuname": "统计报表",
                    "menus": [{"menuid": "31", "menuname": "菜单", "icon": "icon-page", "url": "demo1.html"},
                        {"menuid": "32", "menuname": "菜单", "icon": "icon-class", "url": "demo2.html"}
                    ]
                }
            ]
        };
        ...
        function serverLogin() {
            ...
            if ($newpass.val().length < 6 && $newpass.val().length > 20) {
                msgShow('系统提示', '密码6-20个字符！请重新输入', 'warning');
                return false;
            }
            ...
            $.post('mgrupdate?password=' + $newpass.val(), function (msg) {
...
<body onload="onload()" class="easyui-layout" style="overflow-y: hidden" scroll="no">
<noscript>
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        line-height: 20px;color: #fff; font-family: Verdana, 微软雅黑,黑体"><span style="float:right; padding-right:20px;"
                                                                            class="head">欢迎 <%=session.getAttribute("manager")%> <a
        href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span> <span
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
    <div id="tabs" class="easyui-tabs" fit="true" border="false">
        <div title="首页" style="padding:20px;overflow:hidden; color:red; ">
            <h1 style="font-size:24px;" align="center">欢迎使用洗浴后台管理系统</h1>
        </div>
    </div>
</div>
