...
.login ul{padding-top:10px; border-top:1px solid #fff}
...
$(document).ready(function(){
	...
	$("#t_UserName").formValidator({onshow:"6-20个字符",onfocus:"6-20个字符"}).inputValidator({min:6,max:20,onerror:"输入有误"});
...
<body>
    ...
    <div class="reg">
        <form action="mgradd" method="post" name="form1" id="form1">
            <dl>
                <dt class="f14 b">帐户信息</dt>
                <dd><span class="title">登录账号：</span><input class="reg_input" name="name" id="t_UserName" onblur="checkusername(this.value);" type="text" maxlength="20"/><span id="t_UserNameTip" class="onshow"></span></dd>
                ...
                <dd><span class="title">确认登录密码：</span><input onblur="checkdoublepassword();" class="reg_input" type="password" id="t_RePass" name="repassword"/><span id="t_RePassTip" class="onshow"></span></dd>
                <dd><span class="title">角色：</span><select name="role">
                																<option value="superManager">超级管理员</option>
      	  																		<option value="manager" selected>管理员</option>
                															</select></dd>
             </dl>
            <div class="f_reg_but"><input id="button" name="button" type="submit" value="添加" class="r_button"/></div>
        </form>                              
    </div>       
</body>
</html>